...
<form action="<?php echo e($action); ?>" method="POST" class="ms-2 inline">
    ...
    <button
        type="submit"
        class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold p-1 rounded mb-2 py-4 px-5 md:mb-0 text-center text-xs"
        >
        -
    </button>
</form>
<?php /**PATH C:\xampp\htdocs\tienda\resources\views/components/cart-decrementor.blade.php ENDPATH**/ ?>