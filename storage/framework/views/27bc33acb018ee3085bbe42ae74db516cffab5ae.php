        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <p class="text-lg font-bold">Saldo disponible: $<?php echo e(number_format(auth()->user()->balance, 0, ',', '.')); ?></p> 
                    <p class="text-lg font-bold">Total a pagar: $<?php echo e(number_format($cart->getTotalCost(false), 0, ',', '.')); ?></p> 
                    ...
                    <ul>
                        <?php $__currentLoopData = $cart->getCart(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><?php echo e(data_get($item, 'product.name')); ?> - $<?php echo e(number_format($cart->getTotalCostForProduct(data_get($item, 'product'), false), 0, ',', '.')); ?></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>

                    <h3 class="text-lg font-semibold mt-6">Seleccionar método de pago:</h3>
                    <form action="<?php echo e(route('cart.processPayment')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\tienda\resources\views/cart/checkout.blade.php ENDPATH**/ ?>